            ...
            <CardContent>
              <div className="flex items-center justify-between">
                ...
                <div className="text-right">
                  <p className="text-sm text-muted-foreground">Tanggal tagihan berikutnya</p>
                  ...
                  <div className="space-y-3">
                    <div className="flex items-center justify-between">
                      ...
                      <span className="text-sm text-muted-foreground">
                        {item.limit === -1 ? 'Unlimited' : `of ${item.limit.toLocaleString()}`} {item.unit}
                      </span>
                    </div>
                    {item.limit !== -1 && (
              ...
              <div className="space-y-3">
                <div className="flex items-center justify-between p-3 bg-yellow-50 rounded-lg border border-yellow-200">
                  <div className="flex items-center">
                    ...
                    <span className="text-sm">You've used 84.7% of your document processing limit</span>
                  </div>
                ...
                <div className="flex items-center justify-between p-3 bg-green-50 rounded-lg border border-green-200">
                  <div className="flex items-center">
                    ...
                    <span className="text-sm">All other services are within normal usage</span>
                  </div>
                </div>
              </div>
            </CardContent>
                ...
                <table className="w-full">
                  ...
                  <tbody className="space-y-2">
                    ...
                    <tr className="border-b">
                      ...
                      {plans.map((plan) => (
                        <td key={plan.name} className="text-center py-2">
                          {plan.limits.aiChats === -1 ? 'Unlimited' : plan.limits.aiChats.toLocaleString()}
                        </td>
                      ))}
                    </tr>
                    <tr className="border-b">
