...
import { Star, Clock, Phone, Video, MessageCircle, CheckCircle, ArrowLeft, Users, TrendingUp } from 'lucide-react';
        ...
        <div className="relative min-h-screen flex-1 overflow-hidden">
          ...
          <div className="relative z-10 p-8">
            <div className="text-center">
              <h1 className="text-2xl font-bold text-destructive mb-4">Konsultan tidak ditemukan</h1>
          ...
          <div className="glass border-b p-4 h-20 flex items-center w-full">
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-sm text-muted-foreground">Detail lengkap dan booking konsultasi</p>
              </div>
            </div>
          </div>
                      ...
                      <div className="flex-1">
                        <div className="flex items-start justify-between mb-4">
                          <div>
                            <div className="flex items-center gap-2 mb-2">
                              <h1 className="text-2xl font-bold">{consultant.fullName}</h1>
                              {consultant.isVerified && (
                                <CheckCircle className="h-6 w-6 text-primary" />
                              )}
                            </div>
                            <p className="text-lg text-muted-foreground mb-2">{consultant.title}</p>
                            <Badge variant="secondary" style={{ backgroundColor: consultant.category.color + '20', color: consultant.category.color }}>
                        ...
                        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-4">
                          <div className="text-center">
                            ...
                            <p className="text-sm text-muted-foreground">{consultant.totalReviews} ulasan</p>
                          </div>
                          <div className="text-center">
                            <div className="flex items-center justify-center mb-1">
                          ...
                          <div className="text-center">
                            ...
                            <p className="text-sm text-muted-foreground">respon</p>
                          </div>
                        </div>
                ...
                <Tabs defaultValue="about" className="w-full">
                  ...
                  <TabsContent value="about" className="space-y-6">
                    <Card className="glass border-2">
                      ...
                      <CardContent>
                        <p className="leading-relaxed text-muted-foreground">{consultant.bio}</p>
                      </CardContent>
                    </Card>
                    ...
                    {consultant.education && (
                      <Card className="glass border-2">
                        ...
                        <CardContent>
                          <p className="text-muted-foreground">{consultant.education}</p>
                        </CardContent>
                      </Card>
                    )}
                      ...
                      {reviews.length > 0 ? (
                            ...
                            <CardContent className="p-4">
                              <div className="flex items-start gap-4">
                                <Avatar className="h-10 w-10">
                                  <AvatarImage src={undefined} alt={review.client.name} />
                                  <AvatarFallback>
                                  ...
                                  <div className="flex items-center justify-between mb-2">
                                    ...
                                    <div className="flex items-center gap-1">
                                      {[...Array(5)].map((_, i) => (
                                        <Star
                                          key={i}
                                          className={`h-4 w-4 ${i < review.rating ? 'text-yellow-400 fill-current' : 'text-muted'}`}
                                        />
                                      ))}
                                    </div>
                                  </div>
                        ...
                        <Card className="glass border-2">
                          <CardContent className="p-8 text-center">
                            <p className="text-muted-foreground">Belum ada ulasan untuk konsultan ini.</p>
                          </CardContent>
                        </Card>
                      )}
                    </div>
              ...
              <div className="lg:col-span-1">
                <Card className="sticky top-4 glass border-2">
                  ...
                  <CardContent className="space-y-4">
                    <div className="text-center">
                      <div className="text-3xl font-bold">Rp {consultant.hourlyRate.toLocaleString('id-ID')}</div>
                    ...
                    <Dialog open={bookingDialogOpen} onOpenChange={setBookingDialogOpen}>
                      <DialogTrigger asChild>
                        <Button className="w-full" size="lg" disabled={isBooking}>
                          Book Sekarang
                        </Button>
                      </DialogTrigger>
                      <DialogContent className="max-w-2xl max-h-[90vh] overflow-y-auto">
                        ...
                        <div className="space-y-6">
                          ...
                          <div>
                            ...
                            <Select value={selectedType} onValueChange={setSelectedType}>
                              ...
                              <SelectContent>
                                ...
                                <SelectItem value="phone_call">Telepon</SelectItem>
                          ...
                          <div>
                            ...
                            <Input value={bookingTitle} onChange={(e) => setBookingTitle(e.target.value)} placeholder="Judul sesi" />
                          </div>

                          <div>
                            <Label className="text-base font-medium">Deskripsi</Label>
                            <Textarea value={bookingDescription} onChange={(e) => setBookingDescription(e.target.value)} placeholder="Deskripsi kebutuhan konsultasi" rows={4} />
                          </div>

                          <div>
                            <Label className="text-base font-medium">Durasi (menit)</Label>
                          ...
                          <div className="flex justify-end gap-2">
                            <Button variant="outline" onClick={() => setBookingDialogOpen(false)}>Batal</Button>
                            <Button onClick={handleBooking} disabled={isBooking}>Lanjutkan Pembayaran</Button>
                          </div>
                        </div>
                      </DialogContent>
                    </Dialog>
