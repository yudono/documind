...
const SapIcon = forwardRef<SVGSVGElement, IconProps>(function SapIcon(
  { size = "1em", style, ...props },
  ref
) {
  ...
  return (
    ...
    >
      <defs>
        <style>
          {`.cls-1{fill:url(#linear-gradient);} .cls-1,.cls-2{fill-rule:evenodd;} .cls-2{fill:#fff;}`}
        </style>
        <linearGradient
          id="linear-gradient"
          x1="206.19"
        ...
        >
          <stop offset="0" stopColor="#00b1eb"></stop>
          <stop offset=".212" stopColor="#009ad9"></stop>
          <stop offset=".519" stopColor="#007fc4"></stop>
          <stop offset=".792" stopColor="#006eb8"></stop>
          <stop offset="1" stopColor="#0069b4"></stop>
        </linearGradient>
      </defs>
      <polyline
        className="cls-1"
